...
const html = readFileSync('_bga/wx-burgundy.html', 'utf8');
...
mkdirSync('_bga/wx-burgundy', { recursive: true });
writeFileSync('_bga/wx-burgundy/text.txt', text);
writeFileSync('_bga/wx-burgundy/images.json', JSON.stringify(imgs, null, 2));
